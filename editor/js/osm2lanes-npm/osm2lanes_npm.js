...
function __wbg_adapter_28(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9df732ebb7c01f7c(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {any}
*/
export function js_tags_to_lanes(val) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.js_tags_to_lanes(retptr, addBorrowedObject(val));
...
* @returns {Promise<any>}
*/
export function js_way_to_lanes(osm_way_id) {
    uint64CvtShim[0] = osm_way_id;
    const low0 = u32CvtShim[0];
    const high0 = u32CvtShim[1];
    const ret = wasm.js_way_to_lanes(low0, high0);
...
* @returns {any}
*/
export function js_lanes_to_tags(road, locale) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.js_lanes_to_tags(retptr, addBorrowedObject(road), addBorrowedObject(locale));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
function __wbg_adapter_86(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__hbe94d334d7f8f0dd(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('osm2lanes_npm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
